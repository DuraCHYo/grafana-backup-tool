...
### Changed
- fix regular expression in dashboardApi.py search dashboards

# [v1.5.0] - 2026-02-22

### Changed
- re-add parallel API calls with rate-limited ThreadPoolExecutor (#5) (by Ashish kumar choubey @ashishkr96)
